...
public class AppDbContext : DbContext
{
    ...
    new SoilLookup { ID = 5, ShortCode = "ST1-S", Name = "Dry - MCT (stoney phase)" },
    new SoilLookup { ID = 6, ShortCode = "ST2", Name = "Fresh - MCT" },
    new SoilLookup { ID = 7, ShortCode = "ST2-G", Name = "Fresh - MCT (granite phase)" },
    new SoilLookup { ID = 8, ShortCode = "ST2-GS", Name = "Fresh - MCT (granite stoney phase)" },
    new SoilLookup { ID = 9, ShortCode = "ST2-L", Name = "Fresh - MCT (loamy phase)" },
    new SoilLookup { ID = 10, ShortCode = "ST2-LS", Name = "Fresh - MCT (loamy stoney phase)" },
    new SoilLookup { ID = 11, ShortCode = "ST2-S", Name = "Fresh - MCT (stoney phase)" },
    new SoilLookup { ID = 12, ShortCode = "ST3", Name = "Moist - MCT" },
    new SoilLookup { ID = 13, ShortCode = "ST3-G", Name = "Moist - MCT (granite phase)" },
    new SoilLookup { ID = 14, ShortCode = "ST3-GS", Name = "Moist - MCT (granite stoney phase)" },
    new SoilLookup { ID = 15, ShortCode = "ST3-L", Name = "Moist - MCT (loamy phase)" },
    new SoilLookup { ID = 16, ShortCode = "ST3-LS", Name = "Moist - MCT (loamy stoney phase)" },
    new SoilLookup { ID = 17, ShortCode = "ST3-S", Name = "Moist - MCT (stoney phase)" },
    new SoilLookup { ID = 18, ShortCode = "ST4", Name = "Wet - MCT" },
    new SoilLookup { ID = 19, ShortCode = "ST4-G", Name = "Wet - MCT (granite phase)" },
    new SoilLookup { ID = 20, ShortCode = "ST4-GS", Name = "Wet - MCT (granite stoney phase)" },
    new SoilLookup { ID = 21, ShortCode = "ST4-S", Name = "Wet - MCT (stoney phase)" },
    new SoilLookup { ID = 22, ShortCode = "ST5", Name = "Fresh - FMT" },
    new SoilLookup { ID = 23, ShortCode = "ST5-S", Name = "Fresh - FMT (stoney phase)" },
    new SoilLookup { ID = 24, ShortCode = "ST6", Name = "Moist - FMT" },
    new SoilLookup { ID = 25, ShortCode = "ST6-S", Name = "Moist - FMT (stoney phase)" },
    new SoilLookup { ID = 26, ShortCode = "ST7", Name = "Wet - FMT" },
    new SoilLookup { ID = 27, ShortCode = "ST7-S", Name = "Wet - FMT (stoney phase)" },
    new SoilLookup { ID = 28, ShortCode = "ST8", Name = "Rich Fresh - MCT" },
    new SoilLookup { ID = 29, ShortCode = "ST8-C", Name = "Rich Fresh - MCT (coarse phase)" },
    new SoilLookup { ID = 30, ShortCode = "ST8-CS", Name = "Rich Fresh - MCT (coarse stoney phase)" },
    new SoilLookup { ID = 31, ShortCode = "ST8-S", Name = "Rich Fresh - MCT (stoney phase)" },
    new SoilLookup { ID = 32, ShortCode = "ST9", Name = "Rich Moist - MCT" },
    new SoilLookup { ID = 33, ShortCode = "ST9-C", Name = "Rich Moist - MCT (coarse phase)" },
    new SoilLookup { ID = 34, ShortCode = "ST9-CS", Name = "Rich Moist - MCT (coarse stoney phase)" },
    new SoilLookup { ID = 35, ShortCode = "ST9-S", Name = "Rich Moist - MCT (stoney phase)" },
    new SoilLookup { ID = 36, ShortCode = "ST10", Name = "Rich Wet - MCT" },
    new SoilLookup { ID = 37, ShortCode = "ST10-S", Name = "Rich Wet - MCT (stoney phase)" },
    new SoilLookup { ID = 38, ShortCode = "ST11", Name = "Rich Fresh - FMT" },
    new SoilLookup { ID = 39, ShortCode = "ST11-S", Name = "Rich Fresh - FMT (stoney phase)" },
    new SoilLookup { ID = 40, ShortCode = "ST12", Name = "Rich Moist - FMT" },
    new SoilLookup { ID = 41, ShortCode = "ST12-S", Name = "Rich Moist - FMT (stoney phase)" },
    new SoilLookup { ID = 42, ShortCode = "ST13", Name = "Rich Wet - FMT" },
    new SoilLookup { ID = 43, ShortCode = "ST13-S", Name = "Rich Wet - FMT (stoney phase)" },
    new SoilLookup { ID = 44, ShortCode = "ST14", Name = "Organic" },
    new SoilLookup { ID = 45, ShortCode = "ST14-S", Name = "Organic (stoney phase)" },
    new SoilLookup { ID = 46, ShortCode = "ST14-U", Name = "Organic (upland phase)" },
    new SoilLookup { ID = 47, ShortCode = "ST14-US", Name = "Organic (upland stoney phase)" },
    new SoilLookup { ID = 48, ShortCode = "ST15", Name = "Dry Shallow - MCT" },
    new SoilLookup { ID = 49, ShortCode = "ST15-G", Name = "Dry Shallow - MCT (granite phase)" },
    new SoilLookup { ID = 50, ShortCode = "ST15-GS", Name = "Dry Shallow - MCT (granite stoney phase)" },
    new SoilLookup { ID = 51, ShortCode = "ST15-L", Name = "Dry Shallow - MCT (loamy phase)" },
    new SoilLookup { ID = 52, ShortCode = "ST15-LS", Name = "Dry Shallow - MCT (loamy stoney phase)" },
    new SoilLookup { ID = 53, ShortCode = "ST15-S", Name = "Dry Shallow - MCT (stoney phase)" },
    new SoilLookup { ID = 54, ShortCode = "ST16", Name = "Moist Shallow - MCT" },
    new SoilLookup { ID = 55, ShortCode = "ST16-G", Name = "Moist Shallow - MCT (granite phase)" },
    new SoilLookup { ID = 56, ShortCode = "ST16-GS", Name = "Moist Shallow - MCT (granite stoney phase)" },
    new SoilLookup { ID = 57, ShortCode = "ST16-L", Name = "Moist Shallow - MCT (loamy phase)" },
    new SoilLookup { ID = 58, ShortCode = "ST16-LS", Name = "Moist Shallow - MCT (loamy stoney phase)" },
    new SoilLookup { ID = 59, ShortCode = "ST16-S", Name = "Moist Shallow - MCT (stoney phase)" },
    new SoilLookup { ID = 60, ShortCode = "ST17", Name = "Rich Dry Shallow - MCT" },
    new SoilLookup { ID = 61, ShortCode = "ST17-S", Name = "Rich Dry Shallow - MCT (stoney phase)" },
    new SoilLookup { ID = 62, ShortCode = "ST18", Name = "Rich Moist Shallow - MCT" },
    new SoilLookup { ID = 63, ShortCode = "ST18-S", Name = "Rich Moist Shallow - MCT (stoney phase)" },
    new SoilLookup { ID = 64, ShortCode = "ST19", Name = "Talus" },
...
new VegLookup { ID = 5, ShortCode = "CO1", Name = "Black spruce - Balsam fir / Foxberry / Plume moss" },
new VegLookup { ID = 6, ShortCode = "CO2", Name = "White spruce - Balsam fir / Foxberry / Twinflower" },
new VegLookup { ID = 7, ShortCode = "CO2a", Name = "White spruce - Balsam fir / Foxberry / Twinflower (Black crowberry Headland variant)" },
new VegLookup { ID = 8, ShortCode = "CO3", Name = "Red spruce / Mountain-ash / Foxberry" },
new VegLookup { ID = 9, ShortCode = "CO4", Name = "Balsam fir / Foxberry - Twinflower" },
new VegLookup { ID = 10, ShortCode = "CO5", Name = "White birch - Balsam fir / Foxberry - Wood aster" },
...
new VegLookup { ID = 36, ShortCode = "KA2", Name = "Sugar maple / Christmas fern - Rattlesnake fern - Bulblet bladder fern" },
...
new VegLookup { ID = 40, ShortCode = "MW3", Name = "Hemlock - Yellow birch / Evergreen wood" },
...
new VegLookup { ID = 87, ShortCode = "TH5", Name = "Beech / Sarsaparllla / Leaf litter" },
