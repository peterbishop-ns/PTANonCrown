...
namespace PTANonCrown.Services
{
    ...
    {
        { "AgeGeneral", "A minimum of one tree must be cored with an increment borer and aged for each PTA plot. If the plot is not suspected to be old growth, the age tree is selected as a codominant tree of average diameter (e.g., the quadratic mean diameter of the plot). The most abundant, merchantable species should be used and LIT species are preferred. If old growth is suspected, the tree selected to age should be from the most dominant LIT/LT species in the plot and should be representative of the top 20% of the basal area." },
        ...
        { "CWMTransectLength", "Length of the transect used to measure coarse woody material." },
...
{ "CWMSpeciesGroup", "Softwood (SW), hardwood (HW), or unknown species." },
        ...
        { "Exposure", "Exposure refers to the relative openness of a site to weather conditions, particularly\r\nwind and sun. Exposure can affect moisture conditions on a site and severely impact the height growth of trees." },
        ...
        { "FECVeg", "The Forest Ecosystem Classification (FEC) vegetation type. Record whether the vegetation type is an inclusion or generally representative of the stand. If the vegetation type is within the Planted Forest Group, record whether the plot is located on an Acadian, Maritime Boreal, or Coastal site." },
        ...
        { "LivingTreeLIT", "Longlived, intermediate to shade tolerant." },
        { "LivingTreeLT", "Legacy Tree." },
        ...
        { "StockingLITSeedTree", "Percent stocking of LIT trees of seed-bearing age at 20-m spacing." } ,
        { "StockingRegenCommercialSpecies", "Percent stocking of all commercial tree species in 10% stocking classes." } ,
        { "StockingRegenLITSpecies", "Percent stocking of all LIT species in 10% stocking classes." },
        ...
        { "UnevenAged", "Includes two-aged, multi-aged, and all-aged stands." } ,
