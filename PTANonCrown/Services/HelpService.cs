...
namespace PTANonCrown.Services
{
        ...
        private readonly Dictionary<string, string> _helpTexts = new()
    {
        ...
        { "CoarseWoodyTransectDirection", "Direction of the transect used to measure coarse woody material." },
        { "CoarseWoodyTransectLength", "Length of the transect used to measure coarse woody material." },
